%% Part 1: Estimation and validation of the DCM (Univariate model for Pickups)
...
%% Create the model
pick_selected_model = stem_model(obj_stem_data, obj_stem_par);
...
%% Model validation
pick_selected_model.set_varcov;
pick_selected_model.set_logL;

%% Save results
save('pick_selected_model_results.mat', 'pick_selected_model');